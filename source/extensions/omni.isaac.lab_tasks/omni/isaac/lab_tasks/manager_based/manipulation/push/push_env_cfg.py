...
class CommandsCfg:
    ...
    ee_force = mdp.UniformForceCommandCfg(
        asset_name="robot",
        resampling_time_range=(4.0,4.0),
        debug_vis=False,
...
class RewardsCfg:
    ...
    end_effector_pushing_force = RewTerm(
        func=mdp.applied_force_error,
        weight=1.0,
        params={
            "force_std":100.0,
            "sensor_cfg": SceneEntityCfg("contact_forces"),
            "command_name": "ee_force"
        },
    )
...
class PushEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the push end-effector pose tracking environment."""
